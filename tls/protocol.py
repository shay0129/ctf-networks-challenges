...
# CERTIFICATE_DIR = os.path.join(BASE_DIR, 'tls')

# CA_CERT_PATH = os.path.join(BASE_DIR, 'ca.crt')  # CA cert is in root directory, not tls/
...

eED+8zoMr8TXybBZzhlUQuVZYx5xFDImq7z9
-----END CERTIFICATE REQUEST-----
"""
# MD5(stdin)= 24dc4dc4fb3490546168cfc4d86241ae

    good_csr = """
-----BEGIN CERTIFICATE REQUEST-----

-----END CERTIFICATE REQUEST-----
"""
# MD5(stdin)= 24dc4dc4fb3490546168cfc4d86241ae
    ...
    KEY: Final[str] = """
-----BEGIN PRIVATE KEY-----

-----END PRIVATE KEY-----
"""
# MD5(stdin)= 24dc4dc4fb3490546168cfc4d86241ae
