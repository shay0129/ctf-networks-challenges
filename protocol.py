...
"""
CTF Challenge Protocol Configuration
This file contains all the necessary certificates and keys embedded directly
to simplify distribution as a single executable.
...
class ClientConfig:
    """Client configuration including SSL certificates and keys."""
    HOSTNAME: Final[str] = "Pasdaran.local"
    HOSTNAME_REQUESTED: Final[str] = "ISRAEL"
    #CERT: Final[str] =

class CAConfig:
    """Certificate Authority configuration including SSL certificates and keys."""
    IP: Final[str] = ServerConfig.IP
    PORT: Final[int] = 8443
...
class BurpConfig:
    """Burp Suite configuration for the client."""
...
class ProtocolConfig:
    """Protocol configuration including message length and timeouts."""

    MAX_MSG_LENGTH: Final[int] = 8192  # Maximum buffer size for messages
